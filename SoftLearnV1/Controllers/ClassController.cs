...
namespace SoftLearnV1.Controllers
{
    ...
    public class ClassController : ControllerBase
    {
        ...
        [Authorize]
        public async Task<IActionResult> createClass(ClassCreateRequestModel obj)
        {
        ...
        [Authorize]
        public async Task<IActionResult> createClassGrades(ClassGradeCreateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [HttpPut("updateClass")]
        [Authorize]
        public async Task<IActionResult> updateClassAsync(long classId, ClassCreateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> updateClassGradeAsync(long classGradeId, ClassGradeCreateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
