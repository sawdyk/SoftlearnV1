...
namespace SoftLearnV1.Controllers
{
    ...
    public class LessonNoteController : ControllerBase
    {
        ...
        [Authorize]
        public async Task<IActionResult> createLessonNotesAsync([FromBody] LessonNoteCreateRequestModel obj)
        {
        ...
        [Authorize]
        public async Task<IActionResult> updateLessonNotesAsync(long lessonNoteId, LessonNoteCreateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> createSubjectNotesAsync([FromBody] SubjectNoteCreateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> updateSubjectNotesAsync(long subjectNoteId, SubjectNoteCreateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
