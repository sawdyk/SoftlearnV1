...
namespace SoftLearnV1.Controllers
{
    ...
    public class ScoresConfigController : ControllerBase
    {
        ...
        [Authorize]
        public async Task<IActionResult> createScoreGradesAsync(ScoreGradeCreateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> updateScoreGradeAsync(long scoreGradeId, ScoreGradeCreateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> createScoreCategoryConfigAsync(ScoreCategoryConfigRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> updateScoreCategoryConfigAsync(long scoreCategoryConfigId, ScoreCategoryConfigRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> createScoreSubCategoryConfigAsync(ScoreSubCategoryConfigRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> updateScoreSubCategoryConfigAsync(long scoreSubCategoryConfigId, ScoreSubCategoryConfigRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
