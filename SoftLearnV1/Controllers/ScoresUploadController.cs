...
namespace SoftLearnV1.Controllers
{
    ...
    public class ScoresUploadController : ControllerBase
    {
        ...
        [Authorize]
        public async Task<IActionResult> uploadScoresAsync([FromBody]UploadSubjectScoreRequestModel obj)
        {
        ...
        [Authorize]
        public async Task<IActionResult> updateScoresAsync([FromBody]UploadSubjectScoreRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> uploadSingleStudentScoreAsync([FromBody]UploadScorePerSubjectAndStudentRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> updateSingleStudentScoresAsync([FromBody]UploadScorePerSubjectAndStudentRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> createScoreUploadSheetTemplateAsync([FromBody]ScoreUploadSheetTemplateRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
        ...
        [Authorize]
        public async Task<IActionResult> bulkScoresUploadAsync([FromForm]BulkScoresUploadRequestModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest();
