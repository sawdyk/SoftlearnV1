...
namespace SoftLearnV1.Repositories
{
    public class ExtraCurricularBehavioralScoreRepo : IExtraCurricularBehavioralScoresRepo
    {
        ...
        public async Task<UploadScoreResponseModel> uploadExtraCurricularBehavioralScoresAsync(UploadScoreRequestModel obj)
        {
            try
            {
        ...
        public async Task<UploadScoreResponseModel> uploadSingleStudentExtraCurricularBehavioralScoreAsync(UploadScorePerStudentRequestModel obj)
        {
            try
            {
                IList<object> existingScores = new List<object>();
        ...
        public async Task<UploadScoreResponseModel> updateExtraCurricularBehavioralScoresAsync(UploadScoreRequestModel obj)
        {
            try
            {
                IList<object> existingScores = new List<object>();
        ...
        public async Task<GenericResponseModel> getExtraCurricularBehavioralScoresAsync(long schoolId, long campusId, long classId, long classGradeId, long categoryId, long subCategoryId, long termId, long sessionId)
        {
            try
            {
                //Validations
        ...
        public async Task<GenericResponseModel> getExtraCurricularBehavioralScoresByStudentIdAndCategoryIdAsync(Guid studentId, long schoolId, long campusId, long classId, long classGradeId, long categoryId, long termId, long sessionId)
        {
            try
            {
                //Validations
        ...
        public async Task<GenericResponseModel> getExtraCurricularBehavioralScoresByStudentIdAsync(Guid studentId, long schoolId, long campusId, long classId, long classGradeId, long categoryId, long subCategoryId, long termId, long sessionId)
        {
            try
            {
                //Validations
        ...
        public async Task<GenericResponseModel> deleteExtraCurricularBehavioralScoresForAllStudentAsync(long schoolId, long campusId, long classId, long classGradeId, long categoryId, long subCategoryId, long termId, long sessionId)
        {
            try
            {
                if (categoryId == (long)EnumUtility.ScoreCategory.ExtraCurricular)
                ...
                return new GenericResponseModel { StatusCode = 200, StatusMessage = "Kindly Select the Category(Extracurricular/Behavioural)", };
            }
            catch (Exception exMessage)
            {
                ErrorLogger err = new ErrorLogger();
        ...
        public async Task<GenericResponseModel> deleteExtraCurricularBehavioralScoresForSingleStudentAsync(Guid studentId, long schoolId, long campusId, long classId, long classGradeId, long categoryId, long subCategoryId, long termId, long sessionId)
        {
            try
            {
                if (categoryId == (long)EnumUtility.ScoreCategory.ExtraCurricular)
        ...
        public async Task<GenericResponseModel> deleteExtraCurricularBehavioralScoresPerCategoryForAllStudentAsync(long schoolId, long campusId, long classId, long classGradeId, long categoryId, long termId, long sessionId)
        {
            try
            {
                if (categoryId == (long)EnumUtility.ScoreCategory.ExtraCurricular)
        ...
        public async Task<GenericResponseModel> deleteExtraCurricularBehavioralScoresPerCategoryForSingleStudentAsync(Guid studentId, long schoolId, long campusId, long classId, long classGradeId, long categoryId, long termId, long sessionId)
        {
            try
            {
                if (categoryId == (long)EnumUtility.ScoreCategory.ExtraCurricular)
